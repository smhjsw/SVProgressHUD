...
- (UIColor*)foregroundColorForStyle {
    if(self.defaultStyle == SVProgressHUDStyleLight) {
        ...
        /// smhjsw
        return [UIColor colorWithRed:157.0f / 255.0f green:157.0f / 255.0f blue:157.0f / 255.0f alpha:1.0f];
    } else {
...
- (void)fadeInEffects {
    if(self.defaultStyle != SVProgressHUDStyleCustom) {
        ...
        if (self.defaultStyle == SVProgressHUDStyleDark) {
            self.hudView.backgroundColor = [UIColor colorWithRed:32.0f / 255.0f green:33.0f / 255.0f blue:36.0f / 255.0f alpha:1.0f];
        } else {
